...
class NormalInverseWishart(): 
    ...
    def to(self, device):
        ...
        """
        if hasattr(self, 'lambda_mu_0') and self.lambda_mu_0 is not None:
            self.lambda_mu_0 = self.lambda_mu_0.to(device)
            
        if hasattr(self, 'lambda_mu') and self.lambda_mu is not None:
            self.lambda_mu = self.lambda_mu.to(device)
