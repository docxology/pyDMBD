...
class Gamma():
    ...
    def to(self, device):
        ...
        if hasattr(self, 'alpha_0') and self.alpha_0 is not None:
            self.alpha_0 = self.alpha_0.to(device)
            
        if hasattr(self, 'beta_0') and self.beta_0 is not None:
            self.beta_0 = self.beta_0.to(device)
